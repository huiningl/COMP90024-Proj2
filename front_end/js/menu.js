...
function setProperties(e, t) {
    for (var n in t)
        if (0 == n.indexOf("child:")) {
            for (var i = n.substr(6).split(":"), a = e, u = 0; u < i.length; u++) a = $(a).children().eq(i[u]);
            null != t[n].tag && (a = $(a).find(t[n].tag)), setProperties(a, t[n].properties)
        } else "animate" != n && "duration" != n && ("style" == n ? t[n].length ? $(e).attr(n, t[n]) : $(e).removeAttr(n) : $(e).css(n, t[n]))
}
...
function setupMenu(e) {
    if (menuData = getMenuData(e), null == menuData) return !1;
...
function getMenuData(e) {
    ...
    return $.each(n, function(e, n) {
        if (null != (t = getMenuDataForClass(n))) return !1
    }), t
}
MenuItem.prototype.addEvents = function() {
    var e = function(e) {
            if ("touchstart" == e.type) {
                if (0 == menuTouchEvent && (menuTouchEvent = !0, 1 == menuClickEvent)) return
            } else if (1 == menuTouchEvent && "click" == e.type) return;
            for (var t, n = e.target, i = $(n).data("item-data"); null == i && null != n;) n = n.parentElement, i = $(n).data("item-data");
            if (n == this || "A" == this.nodeName)
                if (null != i.subMenu) "none" == $(i.subMenu.element).css("display") ? (i.hoverIn.call(i.element, e), i.expand()) : $(i.subMenu.element).is(":animated") || setTimeout((t = i.parent.element, function() {
                    closeMenu(t)
                }), 50);
                else {
                    if (1 == menuPageScroll) return menuPageScroll = !1, void(null != i.hoverOut && i.hoverOut.call(i.element));
                    for (var a; null != i.parent;) a = i.parent.element, i = i.parent;
    ...
    if (null != e) {
        ...
        var a = this;
        for (i = a.element; null != a.parent;) i = (a = a.parent).element;
        for (var u = n; null != e && u >= 0 && null == e[u];) --u;
        u >= 0 && null != e && (e = e[u]);
        var r = $.extend({}, e);
    ...
    var u, r = null != t && null != t.queue ? t.queue : "fx";
    for (var o in $(i).stop(r, !0).animate(this.getAnimationProperties(a.properties, t), {
        ...
        if (0 == o.indexOf("child:")) {
            for (var s = o.substr(6).split(":"), l = i, d = 0; d < s.length; d++) l = $(l).children().eq(s[d]);
    ...
    if (null != t) {
        ...
        if (i < n.length) {
            ...
            if (a.length > 0) {
                var u, r = a.split(":"),
                    o = r[0];
                if ("push_right" == o)(l = r[2]) < 0 && (o += "_move_up"), u = {
                    dx: r[1],
                    dy: l
                };
                else if ("push_left" == o) {
    ...
    if (null != t) {
        ...
        if (i < n.length) {
            ...
            if (a.length > 0) {
                var u, r = a.split(":"),
                    o = r[0];
                if ("push_right" == o) o = "pull_left", (l = r[2]) < 0 && (o += "_move_down"), u = {
                    dx: r[1],
                    dy: l
                };
                else if ("push_left" == o) {
...
function show(e) {
    $(e).each(function() {
        ...
        return function(n) {
            for (var i = $(e).data("item-data"), a = e; null != i.parent;) a = (i = i.parent).element;
